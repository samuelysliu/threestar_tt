            ...
            <Row>
              <Col>
                {isUnlocking ? (
                  ...
                  <Button style={longButtonStyle} onClick={unlock}>
                    Unlock
                  </Button>
                )}
              </Col>
          ...
          <Row style={blockTwoStyle}>
            <Col>
              {isClaiming ? (
                ...
                <Button
                  disabled={disableDividends}
                  style={longButtonStyle}
                  onClick={claimDevidends}
                >
                  Claim Dividends
                </Button>
              )}
        ...
        <Container style={card}>
          ...
          <Row style={blockFiveStyle}>
            <Col>
              <font>
                You can also get{' '}
                <font style={{ color: '#669BFD' }}>3 Star</font> tokens, by
                playing the games!
              </font>
            </Col>
          </Row>
          <Row style={blockFourStyle}>
            <Col>
              <a href='/'>
                <Button style={longButtonStyle}>Go to play</Button>
              </a>
            </Col>
          </Row>
        </Container>
