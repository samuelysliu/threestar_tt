        ...
        <div className='modalStyle'>
          ...
          <div className='modalContent'>
            <Row style={{ padding: '9px' }}>
              <Col>
                <font>
                  Claim once a day.<br></br>Make you win DOUBLE reward.
                </font>
              </Col>
            </Row>
            <Row style={{ justifyContent: 'center' }}>
              <Col xs={5} style={{ textAlign: 'right' }}>
                <img src={TTTokenIcon2} style={{ width: '60px' }}></img>
              </Col>
              <Col xs={1}>
                <div
                  style={{ borderLeft: '1px solid #0CB1FD', height: '100%' }}
                ></div>
              </Col>
              <Col xs={5} style={{ textAlign: 'left' }}>
                <img src={threeStarTokenIcon2} style={{ width: '60px' }}></img>
              </Col>
            </Row>
            <Row style={{ padding: '9px' }}>
              <Col>
                <font>
                  Spend your original BET and get <strong>TWICE</strong> as much
                  TT or 3Star.
                </font>
              </Col>
            </Row>
          ...
          <div className='claimDiv'>
            <font style={{ color: 'red', fontSize: '12px' }}>
              {errorMessage}
            </font>
            <br></br>
            {isClaimDone ? (
              <button className='disableBt' disabled>
                <ImCheckmark style={{ paddingBottom: '3px' }} />
                CLAIM BONUS
              </button>
            ) : isClaiming ? (
              <button>
                <Spinner
                  animation='border'
                  style={{ color: '#0AB700', width: '1rem', height: '1rem' }}
                />
                CLAIM BONUS
              </button>
            ) : (
